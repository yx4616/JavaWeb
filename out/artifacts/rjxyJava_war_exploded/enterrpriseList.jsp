...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <a href="enterpriseAdd.jsp" target="_self"><img src="images/addEnter.JPG" border="0" /></a>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="30" colspan="3"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <c:forEach items="${list}" var="g">
        <tr>
          <td width="33%" height="30" align="center" bgcolor="#FFF5D7"><span class="txt">${g.Ent_id}</span></td>
          <td width="34%" height="30" align="center" bgcolor="#FFF5D7"><span class="txt">${g.Ent_name}</span></td>
